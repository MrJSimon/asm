...
In the **label Manger**, add or remove labels. The program current suports 9 labels.
...
Please note !!! The brush and eraser tool will only work on the image, not on the entire canvas.
...
Predictions will appear in a seperate window next to the original image.

### 🤖 Step 5: Automation Manager
To apply the trained model to multiple images:

&nbsp;&nbsp;&nbsp;&nbsp; 5.1 Use the **Automation Manager** to select or de-select the images to be predicted  
